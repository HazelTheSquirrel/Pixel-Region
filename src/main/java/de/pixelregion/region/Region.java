...
public final class Region {
    ...
    public Region(
        ...
        if (points == null) {
            throw new IllegalArgumentException("Region points are required.");
        }
    ...
    public Map<RegionFlag, FlagState> flags() {
    ...
    public void rebuildGeometry() {
        geometry = new RegionGeometry(points);
    }
    ...
    public boolean contains(Location location) {
        ...
        return contains(location.getWorld().getUID(), location.getX(), location.getY(), location.getZ());
    }

    public boolean contains(UUID locationWorldId, double x, double y, double z) {
        if (!worldId.equals(locationWorldId) || y < minY || y >= maxY) {
            return false;
        }
        return geometry().contains(x, z);
    }
    ...
    public FlagState flag(RegionFlag flag) {
        return flags.get(flag);
    }

    public boolean hasExplicitFlag(RegionFlag flag) {
